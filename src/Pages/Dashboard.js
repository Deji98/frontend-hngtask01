...
function Dashboard(){
  ...
  <div className='twitter'>
    ...
    <a href=' https://twitter.com/AdesinaAdedej20' target="_blank">AdesinaAdedej20</a>
    </div>
  </div>
  <div className='Zuri'>
<h3>Zuri Team</h3>
...
<div className='books-link'>
    <a href=' https://books.zuri.team/' target="_blank">Zuri Books</a>
    </div>
  </div>
  <div id='book__python' className='python'>
<h3>Python Books</h3>
<div className='python-link'>
    <a href=' https://books.zuri.team/' target="_blank">Python Books</a>
    </div>
  </div>
  <div id='pitch' className='background'>
<h3>Background Check:</h3>
<div className='background-link'>
    <a href=' https://background.zuri.team/' target="_blank">Background Check for coders</a>
    </div>
  </div>
